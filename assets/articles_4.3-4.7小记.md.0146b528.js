import{_ as s,o as a,c as n,N as l}from"./chunks/framework.afd645d4.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/4.3-4.7小记.md"}'),p={name:"articles/4.3-4.7小记.md"},e=l(`<h2 id="_1-上传数据增加" tabindex="-1">1. 上传数据增加 <a class="header-anchor" href="#_1-上传数据增加" aria-label="Permalink to &quot;1. 上传数据增加&quot;">​</a></h2><div class="language-java"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">@</span><span style="color:#C792EA;">ApiOperation</span><span style="color:#89DDFF;">(</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">上传数据</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">)</span></span>
